		...
		<div class="flex items-center justify-center">
			<div>
				<div class="box-1 mx-1 p-5 my-2 relative bg-light-primary rounded-lg">
					<div class="absolute bottom-6 circle rounded-full bg-primary" />
					<div class="lg:text-3xl text-lg font-bold text-primary">Raven Walls</div>
				</div>
				<div class="box-2 mx-1 p-5 relative my-2 bg-primary rounded-lg">
					<div class="circle absolute bottom-6 right-6 rounded-full bg-light-primary" />
					<div class="lg:text-3xl text-lg font-bold text-light-primary">Corvus Themes</div>
				</div>
			</div>
			<div>
				<div class="box-2 mx-1 relative p-5 my-2 bg-primary rounded-lg">
					<div class="circle absolute right-6 rounded-full bg-light-primary" />
					<div class="absolute bottom-5 lg:text-3xl text-lg font-bold text-light-primary">
						Corvus Zen
					</div>
				</div>
